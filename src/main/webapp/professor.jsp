...
<body>
    ...
    <html:form action="/professor" method="post">
        ...
        <html:hidden property="method" value="${professorForm.id == 0 || professorForm.id == null ? 'salvar' : 'atualizar'}"/>
        ...
        <p>
            <html:submit value="${professorForm.id == 0 || professorForm.id == null ? 'Salvar' : 'Atualizar'}"/>
        </p>
    </html:form>
